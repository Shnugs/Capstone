...
Character.create!([
  {
    ...
    feats: nil, 
    flaws: nil, 
    proficiency_bonus: nil, 
    deathsaves_successes: nil, 
    deathsaves_failures: nil, 
    weapon_1_name: "Sword", 
    weapon_1_attack: 4, 
    weapon_1_dmg: "2d6 + 2", 
    weapon_2_name: nil, 
